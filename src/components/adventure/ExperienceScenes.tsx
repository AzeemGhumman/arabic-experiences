...
import type { AdventureScene, DirectionAction, SceneFocus } from "@/lib/learning-types"

export const adventureScenes: Record<string, AdventureScene> = {
...
export function sceneForExperience(id: string): AdventureScene {
  return adventureScenes[id] ?? "street"
}
...
export function SceneMark({ scene, className }: { scene: AdventureScene; className?: string }) {
  return (
