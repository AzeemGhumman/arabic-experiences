...
import { topicImageSrc } from "@/data/learning/topic-images"
import type { TopicId } from "@/lib/learning-types"
import { cn } from "@/lib/utils"

export function TopicPicture({
  topicId,
  className,
}: {
  topicId: TopicId
  ...
  const src = topicImageSrc[topicId]
...
function TopicArt({ id, uid }: { id: TopicId; uid: string }) {
  switch (id) {
    case "numbers":
      return (
        <g>
